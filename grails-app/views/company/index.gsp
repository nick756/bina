		...
		<div id="list-company" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="rocNo" title="${message(code: 'company.rocNo.label', default: 'Roc No')}" />
						...
						<th><g:message code="company.state.label" default="State" /></th>
				...
				<g:each in="${companyInstanceList}" status="i" var="companyInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: companyInstance, field: "rocNo")}</td>
