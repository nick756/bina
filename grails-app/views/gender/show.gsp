	...
	<body>
		...
		<div id="show-gender" class="content scaffold-show" role="main">
			...
			<ol class="property-list gender">
				...
				<g:if test="${genderInstance?.code}">
				<li class="fieldcontain">
					<span id="code-label" class="property-label"><g:message code="gender.code.label" default="Code" /></span>
					
						<span class="property-value" aria-labelledby="code-label"><g:fieldValue bean="${genderInstance}" field="code"/></span>
