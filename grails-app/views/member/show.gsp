	...
	<body>
		...
		<div id="show-member" class="content scaffold-show" role="main">
			...
			<ol class="property-list member">
				...
				<g:if test="${memberInstance?.idType}">
				<li class="fieldcontain">
					<span id="idType-label" class="property-label"><g:message code="member.idType.label" default="Id Type" /></span>
					
						<span class="property-value" aria-labelledby="idType-label"><g:link controller="IDType" action="show" id="${memberInstance?.idType?.id}">${memberInstance?.idType?.encodeAsHTML()}</g:link></span>
					
				</li>
				</g:if>
			
				<g:if test="${memberInstance?.idNumber}">
				<li class="fieldcontain">
					<span id="idNumber-label" class="property-label"><g:message code="member.idNumber.label" default="Id Number" /></span>
					
						<span class="property-value" aria-labelledby="idNumber-label"><g:fieldValue bean="${memberInstance}" field="idNumber"/></span>
