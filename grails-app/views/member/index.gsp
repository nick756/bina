		...
		<div id="list-member" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="member.idType.label" default="Id Type" /></th>
					
						<g:sortableColumn property="idNumber" title="${message(code: 'member.idNumber.label', default: 'Id Number')}" />
				...
				<g:each in="${memberInstanceList}" status="i" var="memberInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: memberInstance, field: "idType")}</td>
					
						<td>${fieldValue(bean: memberInstance, field: "idNumber")}</td>
